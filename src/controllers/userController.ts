...
import { addUser, getUserByEmail, updateUser } from '../models/userModel';
...
const updateUserInformation = async (req: Request, res: Response) => {
    ...
    try {
        const updatedUser = await updateUser(id_usuario, { nombre, correo: email, password });
...
export { registerUser, updateUserInformation };
